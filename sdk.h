...
public:
	...
	inline bool ProcessEvent(uintptr_t address, void* fnobject, void* parms)
	{
		...
		auto fProcessEvent = static_cast<void(*)(void* address, void* fnobject, void* parms)>(index[0x4C]); if (!fProcessEvent) return false; //changes sometimes (needs to be found in ida)
...
public:
	...
	uintptr_t TeamIndex() {
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return *(uintptr_t*)(this + 0x10E8); // FortPlayerStateAthena::TeamIndex 0x1098
	}
...
public:
	...
	void AimWhileJumping(bool action) {
		*(bool*)((uintptr_t)this + 0x4B25) = action; //FortPlayerPawnAthena::bADSWhileNotOnGround 0x4B25
	}
	...
	void playernerds()
	{
		...
		uintptr_t Fly = mem::rpm<uintptr_t>(ue::cached::Base + 0x86C9AAA);
		uintptr_t FlyBuff1 = mem::rpm<uintptr_t>(Fly + 0x9F);
		uintptr_t FlyBuff2 = mem::rpm<uintptr_t>(FlyBuff1 + 0x5E);
		uintptr_t FlyBuff3 = mem::rpm<uintptr_t>(FlyBuff2 + 0xFF);
		uintptr_t FlyBuff4 = mem::rpm<uintptr_t>(FlyBuff3 + 0x440);

		//!!!non cambiare!!!
		mem::wpm<double>(FlyBuff4 + 0x9BE, 0.0001);
		mem::wpm<double>(FlyBuff4 + 0x99B, 0.0001);
		mem::wpm<double>(FlyBuff4 + 0x93D, 0.0001);
	}
	...
	AWeapon* CurrentWeapon() {
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return (AWeapon*)(*(uintptr_t*)((uintptr_t)this + ue::cached::offsets::CurrentWeapon)); //FortPawn::CurrentWeapon 0x868
	}
	AFortAthenaVehicle* GetVehicle() {
		...
		sdkUssage->ProcessEvent((uintptr_t)this, ue::cached::objects::actor::GetVehicle, &result); //FortPlayerPawn::CurrentVehicle 0x2348
